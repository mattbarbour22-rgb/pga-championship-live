...
const TOURNAMENT_STATE_ID = process.env.TOURNAMENT_STATE_ID || '2026-pga-championship';
...
export async function GET(req) {
  ...
  try {
    ...
    const pool = evaluatePool(poolEntries, players, existing?.current_ranks || existing?.previous_ranks || {});
    const currentRanks = {};
